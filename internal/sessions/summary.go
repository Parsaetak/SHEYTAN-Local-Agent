...
func RenderSummaryBlock(sum *SessionSummary) string {
        ...
        b.WriteString("[SESSION SUMMARY — compact rolling memory of this conversation so far. ")
        b.WriteString("It is a derived aid; the exact transcript remains the authoritative history.]\n")
